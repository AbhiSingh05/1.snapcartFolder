            ...
            >
                ...
                <form className='flex flex-col gap-6 w-full'onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <input type='text' id='name' placeholder='eg: 100' className='w-full border border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-400 transition-all'
