    ...
    return (
        <div className='flex flex-col items-center justify-center min-h-[80vh] px-6 text-center bg-linear-to-b from-green-50 to-white'>
            ...
            >
                ...
                >
                    <div className='w-full h-full rounded-full bg-green-7000 blur-2xl' />
                </motion.div>
            </motion.div>
            <motion.h1
            ...
            >
                Thank you for shopping with Snapcart. Your order has been placed and is being
            ...
            >
                ...
                <div className='absolute top-35 left-[30%] w-2 h-2 bg-green-400 rounded-full animate-pulse' />
                <div className='absolute top-42 left-[50%] w-2 h-2 bg-green-400 rounded-full animate-bounce' />
