...
import { IDeliveryAssignment } from '@/app/models/deliveryAssignment.model'
        ...
        return (
            <div className='p-4 pt-[120px] min-h-screen bg-gray-50'>
                <div className='max-w-3xl mx-auto'>
                    ...
                    <p className='text-gray-600 text-sm mb-4'>oredr#{activeOrder.order._id.slice(-6)}</p>
                    ...
                    <div className='mt-6 bg-white rounded-xl border shadow p-6'>
                        {!activeOrder.order.deliveryOtpVerification && !showOtpBox && (
                            ...
                            >{sendOtpLoading?<Loader size={16} className='animate-spin text-white text-center'/>:"Marked as Delivered"}</button>
                        )}
                        {
                            showOtpBox &&
                            <div className='mt-4'>
