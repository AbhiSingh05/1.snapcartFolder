...
function RegisterForm({previousStep}:propType) {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative'>
      ...
      <p className='text-lg text-gray-600 mb-8 flex items-center'>Join Snapcart today <Leaf className='w-5 h-5 text-green-600'/></p>
      <motion.form
...
{
  (() => {
    const formValidaton = name !== "" && email !== "" && password !== "";
    return (
      <button disabled={!formValidaton || loading}
